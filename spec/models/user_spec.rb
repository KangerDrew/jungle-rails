...
RSpec.describe User, type: :model do
  describe 'Validations' do
    ...
    subject { User.new( first_name: 'Test', last_name: 'User', email: 'user@test.com', password: '1234567', password_confirmation: '1234567') }
    ...
    it 'should create user if all the conditions are satisfied' do
      @user = User.create(first_name: "Top", last_name: "Kek", email: 'tyler1@riot.com', password:'123456', password_confirmation:'123456')
  ...
  describe '.authenticate_with_credentials' do
    ...
    it 'allows user to login even with different cases' do
      @user = User.create(first_name: "Top", last_name: "Kek", email: 'eXample@domain.COM', password:'1234567', password_confirmation:'1234567')
